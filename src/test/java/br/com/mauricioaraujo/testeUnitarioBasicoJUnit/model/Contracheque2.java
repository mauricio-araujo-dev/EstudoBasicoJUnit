...
public class Contracheque2 {
	...
	public Contracheque2(String nome , double salarioBruto , double totalDescontos) {
		super();
		this.nome = nome;
	...
	// Método questionario
	public static Contracheque2 questionario() {
		...
		Contracheque2 cc = new Contracheque2(nome, sb , td);
		return cc;
	}
	...
	public Contracheque2(String nome, double salarioBruto, double salarioLiquido, double totalDescontos) {
		super();
		this.nome = nome;
		this.salarioBruto = salarioBruto;
